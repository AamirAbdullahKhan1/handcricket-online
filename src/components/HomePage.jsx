...
function HomePage({ onStartGame }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-[#fefcdb] text-white">
      <h1 className="text-6xl font-bold mb-8 text-slate-800 uppercase tracking-wider">Hand Cricket</h1>
      ...
      >
        <span className='uppercase tracking-wider text-xl'>Player</span> <span className='text-[18px]'>vs</span> <span className='uppercase tracking-wider text-xl'>Computer</span>
      </button>
      <button
        title='Pls wait 🙏🏻'
        disabled
